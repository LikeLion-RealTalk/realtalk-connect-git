                  ...
                  `}>
                    ...
                    {Array.from(remoteUsers.values()).map((remoteUser) => {
                      ...
                      return (
                        ...
                        />
                        <div 
                          id={`no-video-${remoteUser.userId}`}
                          className="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-700 to-gray-900 text-white absolute top-0 left-0"
                        >
                          <div className="text-center">
                            <div className="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                              <span className="text-2xl font-bold">
